...
export default function OrderSummary({ onCheckout }) {
  ...
  return (
    <div className="bg-white rounded-[12px] border border-gray-200 p-4 mb-4 max-w-[480px]">
      {/* Product info */}
      <div className="flex gap-4 mb-2">
        <div className="bg-[#F5F5F5] rounded-[8px] flex items-center justify-center flex-shrink-0 w-[200px] h-[200px]">
          <img
            src={product.image}
            alt={product.name}
      ...
      {/* Total */}
      <div className="border-t border-[#D48806] mt-4 pt-4 flex justify-between items-center">
